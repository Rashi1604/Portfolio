    ...
    <section id="work" className='myWork'>
      <div className="WorkTitle">
        ...
        <div className="content">
          ...
          <p className="desc">
          "Developed a dynamic and user-friendly e-commerce website with seamless navigation, products categorization, and an optimized shopping experience."
          </p>
      ...
      <div className="card">
        ...
        <div className="content">
          ...
          <p className="desc">
          "A secure and reliable password generator that creates strong, unique passwords to keep your accounts safe."
          </p>
          <a className="action" href="#">
            Find out more
            <span aria-hidden="true">
      ...
      <div className="card">
        ...
        <div className="content">
          ...
          <p className="desc">
          "A modern news platform delivering accurate and timely updates across politics, business, tech, and more."
          </p>
          <a className="action" href="#">
            Find out more
            <span aria-hidden="true">
      ...
      <div className="card">
        ...
        <div className="content">
          ...
          <p className="desc">
          "Instantly convert currencies with real-time exchange rates for accurate and hassle-free conversions."
          </p>
          <a className="action" href="#">
            Find out more
            <span aria-hidden="true">
